          ...
          <AnimatePresence mode="wait">
            {view === 'login' && (
              ...
              >
                ...
                <button 
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-slate-200 rounded-xl text-slate-700 font-bold hover:bg-slate-50 hover:border-slate-300 transition-all mb-6 disabled:opacity-70 disabled:cursor-not-allowed"
                >
                ...
                <div className="relative flex items-center py-5 mb-4">
                  ...
                  <span className="flex-shrink-0 mx-4 text-slate-400 text-sm font-medium">O continúa con tu correo</span>
                  <div className="flex-grow border-t border-slate-200"></div>
                </div>
            ...
            {view === 'register' && (
              ...
              >
                ...
                <div className="relative flex items-center py-5 mb-4">
                  <div className="flex-grow border-t border-slate-200"></div>
                  <span className="flex-shrink-0 mx-4 text-slate-400 text-sm font-medium">O usa tu correo</span>
                  <div className="flex-grow border-t border-slate-200"></div>
                </div>
