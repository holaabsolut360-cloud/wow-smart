                ...
                <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden p-8">
                  ...
                  <div className="mb-8 pb-8 border-b border-slate-200">
                    ...
                    <input 
                      ...
                      required
                    />
                    <p className="text-xs text-slate-400 mt-2">Requerido tanto para el registro con Google como por correo.</p>
                  </div>
                  ...
                  <div className="mb-6">
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-white border-2 border-slate-200 hover:border-slate-300 rounded-xl font-bold text-slate-700 transition-all shadow-sm"
                    >
                      {googleLoading ? (
                  ...
                  <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-2 bg-white text-slate-500 font-medium">O regístrate con tu correo</span>
                    </div>
                  </div>
